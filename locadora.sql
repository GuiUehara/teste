...
ALTER TABLE locacao 
ADD status ENUM('Reserva', 'Locado', 'Chegada') NOT NULL DEFAULT 'Reserva',
ADD local_retirada VARCHAR(100) NOT NULL,
ADD local_devolucao VARCHAR(100) NOT NULL,
ADD tanque_saida INT NOT NULL,
ADD tanque_chegada INT NULL,
ADD caucao DECIMAL(10,2) NOT NULL,
ADD devolucao ENUM('na devolução', '5 dias', '15 dias', '30 dias') NOT NULL;
